/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e650dd974efdf2ad8755a828c7d315a9)
// Runtime types generated with workerd@1.20260722.1 2025-03-07 nodejs_compat
interface __BaseEnv_Env {
	AGENTLINK_ROOM: DurableObjectNamespace<import("./index").AgentLinkRoom>;
	AGENTLINK_REGISTRY: DurableObjectNamespace<import("./index").AgentLinkRegistry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "AgentLinkRoom" | "AgentLinkRegistry";
	}
