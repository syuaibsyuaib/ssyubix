...
test("createRoomEvent includes message identity and ordering fields", () => {
  assert.deepEqual(
    createRoomEvent({
      ...
      event: "agent_joined",
      agentId: "AGENT2",
      stableAgentIdentityId: "stable-agent-2",
      name: "agent-two",
      taskId: "TASK001",
      task: { task_id: "TASK001", status: "waiting_for_acceptance" },
      presence: "online",
    ...
    }),
    {
      ...
      room_roles: undefined,
      target_agent_id: undefined,
      target_stable_identity_id: undefined,
      target_role_label: undefined,
      task_id: "TASK001",
      task: { task_id: "TASK001", status: "waiting_for_acceptance" },
      presence: "online",
